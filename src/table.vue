...
export default {
    ...
    created() {
        this.doLayout();
        this.maxHeight = this.$props.virtualScroll
            ? this.$props.virtualScroll.maxColumn * this.itemHeight
            : 0;
    },
    mounted() {
    ...
    methods: {
        reSetItemHeight() {
            setTimeout(() => {
                console.log('看看', document.getElementsByClassName(
                    'virtualItem'
                ));
        ...
        initData() {
            ...
            this.dataList = [];
            console.log('asyncRender: ', this.asyncRender);
        ...
        selectAll(status) {
            ...
            if (
                this.virtualScroll.maxColumn &&
                dataList.length > this.virtualScroll.maxColumn
            ) {
